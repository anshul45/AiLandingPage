...
export function FeatureSection({
  ...
  return (
    <section
      id={id}
      className="relative flex w-full max-w-[100vw] flex-col items-center justify-center overflow-hidden py-16 md:py-24"
    >
      <AnimatedWrapper className="container mx-auto">
        ...
        >
          ...
          <div className="mt-6 flex flex-[0.35] flex-col gap-4 lg:mt-0 lg:max-w-[450px]">
