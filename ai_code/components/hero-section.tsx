...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="container mx-auto flex h-full min-h-[calc(100vh-60px)] flex-col items-center justify-center gap-10 px-4 py-12 lg:px-8">
        <AnimatedWrapper className="flex flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-[450px] text-muted-foreground md:mt-10">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Error
            adipisci corrupti accusamus reiciendis similique assumenda nostrum
            fuga dicta vitae ipsum.
          </p>
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <Button size="lg" asChild className="transition-transform duration-300 hover:scale-[1.03]">
              <Link href="/signup">Get started</Link>
            </Button>
            <Button size="lg" variant="outline" asChild className="transition-transform duration-300 hover:scale-[1.03]">
